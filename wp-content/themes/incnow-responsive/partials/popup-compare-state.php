...
?>
		...
		<!-- Popup Window -->		
	    <div id="popup-compare-state" class="popup mfp-hide">
	        <!--<header>
		        <h1><?php echo $state_name; ?> vs. Delaware LLC's: Which State Is Better?</h1>
	        ...
	        <table>
				...
				<tbody>
					...
					<tr>
						...
						<td><?php if ( get_field( 'state_series_liability_shield', $delaware_id ) == 'yes' ) { echo '<img src="' .  get_stylesheet_directory_uri() . '/assets/images/icon-check.png">'; } else { echo '<img src="' . get_stylesheet_directory_uri() . '/assets/images/x-red.png">'; } ?></td>
					...
					<tr>
						...
						<td><?php if ( get_field( 'state_series_liability_shield' ) == 'yes' ) { echo '<img src="' .  get_stylesheet_directory_uri() . '/assets/images/icon-check.png">'; } else { echo '<img src="' . get_stylesheet_directory_uri() . '/assets/images/x-red.png">'; } ?></td>
