<?php
/**
 * Template Name: Delaware Non Profit Comparision Tables
 */
		...
		<div class="row ">
         	<div class="twelve columns">
         		<ul id="pricing-tables" class="clearfix">
					...
					<li class="one-third">
						<ul class="">
							<li class="name"><h3>Basic Non-Profit</h3></li>
							...
							<li class="button-row"><a class="button" href="https://www.incnow.com/order/?type=new&entity=nonprofitcorporation">Get Started</a></li>
						</ul>
					</li>
					<li class="one-third">
						<ul class="popular">
							<li class="name"><h3>Complete Non-Profit</h3></li>
