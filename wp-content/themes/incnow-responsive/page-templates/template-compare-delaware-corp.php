<?php
/**
 * Template Name: Delaware Corporation Comparision Tables
 */
		...
		<div class="row ">
         	<div class="twelve columns">
         		<ul id="pricing-tables" class="clearfix">
					<li class="one-fourth plan">
						<ul class="pricing-titles ">
							<li class="name"></li>
							<li class="price xtra"><h4>Price</h4></li>
							<li class="pricing-item">Name Search</li>
							<li class="pricing-item">Draft Certificate of Incorporation</li>
							<li class="pricing-item">Annual Registered Agent Service</li>
							<li class="pricing-item">$89 Filing Fee</li>
							...
							<li class="pricing-item">Email Document Delivery</li>
							<li class="pricing-item">1 Business Day Turnaround</li>
						</ul>
					</li>
					<li class="one-fourth">
						<ul class="">
							<li class="name"><h3>Basic Corporation</h3></li>
							<li class="price xtra"><h4>$188</h4></li>
							...
							<li class="pricing-item"><h5>$89 Filing Fee</h5><i class="fa fa-check-circle clrgr"></i></li>
							...
							<li class="pricing-item"><h5>Email Document Delivery</h5><i class="fa fa-times clred"></i></li>
							<li class="pricing-item"><h5>1 Business Day Turnaround</h5><i class="fa fa-times clred"></i></li>
							<li class="button-row"><a class="button" href="https://www.incnow.com/order/?type=new&entity=corporation">Get Started</a></li>
						</ul>
					</li>
					<li class="one-fourth">
						<ul class="popular">
							<li class="name"><h3>Complete Corporation</h3></li>
							<li class="price xtra"><h4><span class="strike">$298<span></span></span> $248</h4><span class="price-more">Use Code SAVE50</span></h4></li>
							<li class="pricing-item"><h5>Name Search</h5><i class="fa fa-check-circle clrgr"></i></li>
							<li class="pricing-item"><h5>Draft Certificate of Incorporation 1500 Shares, No Par</h5><i class="fa fa-check-circle clrgr"></i></li>								
							<li class="pricing-item"><h5>Annual Registered Agent Service</h5><i class="fa fa-check-circle clrgr"></i></li>
							<li class="pricing-item"><h5>$89 Filing Fee</h5><i class="fa fa-check-circle clrgr"></i></li>
					...
					<li class="one-fourth">
						<ul class="">
							<li class="name"><h3>NOW Corporation</h3></li>
							<li class="price xtra"><h4><span class="strike">$399<span></span></span> $349</h4><span class="price-more">Use Code SAVE50</span></h4></li>
							<li class="pricing-item"><h5>Name Search</h5><i class="fa fa-check-circle clrgr"></i></li>
							<li class="pricing-item"><h5>Draft Certificate of Incorporation 1500 Shares, No Par</h5><i class="fa fa-check-circle clrgr"></i></li>								
							<li class="pricing-item"><h5>Annual Registered Agent Service</h5><i class="fa fa-check-circle clrgr"></i></li>
							<li class="pricing-item"><h5>$89 Filing Fee</h5><i class="fa fa-check-circle clrgr"></i></li>
							...
							<li class="pricing-item"><h5>Bylaws</h5><i class="fa fa-check-circle clrgr"></i></li>
							<li class="pricing-item"><h5>Minute Book</h5><i class="fa fa-check-circle clrgr"></i></li>
							<li class="pricing-item"><h5>Email Document Delivery</h5><i class="fa fa-check-circle clrgr"></i></li>
							<li class="pricing-item"><h5>1 Business Day Turnaround</h5><i class="fa fa-check-circle clrgr"></i></li>							
							<li class="button-row"><a class="button" href="https://www.incnow.com/order/?type=new&entity=corporation">Get Started</a></li>
						</ul>
					</li>				
				</ul>
